...
ig.module(
    ...
    .defines(function () {
        ...
        EntityBulletGenerator = ig.Entity.extend({
            ...
            ********************************************************/
            useBullet: function (entityType, parent, attributes, opt_xOffset, opt_yOffSet) {
                ...
                if (this.instances.length > 0) {
                    ...
                    entity = ig.game.spawnEntity(entityType, 0, 0);
                }
                ...
                entity.pos.x = this.parentObject.pos.x + xPos;
                entity.pos.y = this.parentObject.pos.y + yPos;
