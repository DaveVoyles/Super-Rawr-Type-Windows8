ig.module(
    ...
    .defines(function () {
        ...
        StartScreen = ig.Game.extend({
            ...
            stage39Music: new ig.Sound('media/Music/Stage 39.mp3'),
            stage39Music: new ig.Sound('media/Music/Stage 39.ogg'),
            stage39Music: new ig.Sound('media/Music/Stage 39.*'),
            init: function () {
                ...
                ig.music.add(this.stage39Music, 'stage39Music');
                //ig.music.next();
                ig.music.play('stage39Music');
            ...
            gotoNextScreen: function () {
                ig.system.setGame(InstructionsScreen);
            },
            update: function () {
            ...
            draw: function () {
                ...
                //Logo Tray
                this.splashScreenTextures.drawFrame("background-mask.png", this.backgroundObj.x - 25, this.logoObj.y - 30);
