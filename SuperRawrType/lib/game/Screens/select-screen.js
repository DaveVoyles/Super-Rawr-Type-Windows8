...
//    'game.screens.game-screen'
    ...
    .defines(function () {
        ...
        SelectScreen = ig.Game.extend({
            ...
            selectSFX: new ig.Sound("media/SFX/selection.*"),
            init: function() {
              ...
              //  ig.music.play("track1");
                ig.music.add('media/Music/StageSelect5.mp3', 'StageSelect5');
                ig.music.play('StageSelect5');
            ...
            animationOutComplete: function() {
                ig.system.setGameNow(MyGame, ig.game.nextLevelToLoad);
            },
            update:function () {
                this.parent();
...
// Commented this out, as it keeps throwing an error. Works fine without it. - DV 4/6/13
